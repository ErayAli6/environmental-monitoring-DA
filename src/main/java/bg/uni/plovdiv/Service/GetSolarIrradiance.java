...
public class GetSolarIrradiance {
    ...
    public String execute(String zipCode, String countryCode, LocalDate localDate) {
        ...
        String url = "https://api.openweathermap.org/energy/1.0/solar/data?lat=" + lat + "&lon=" + lon + "&date=" + localDate.toString() + "&appid=" + apiKey;
